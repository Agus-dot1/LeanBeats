          ...
          <div className="grid items-center min-h-[calc(100vh-120px)] grid-cols-1 gap-6 lg:grid-cols-12">
            ...
            >
              <motion.div variants={item} className="space-y-6">
                <div className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white rounded-full bg-primary-200/20 backdrop-blur-sm">
                  <Music size={16} className="animate-pulse" />
                  <span>Producción Musical</span>
                </div>
                <h1 className="font-bold leading-none text-white text-7xl lg:text-9xl">
                  Sonidos del
                  <br />
              ...
              <motion.div variants={item} transition={{ duration: .8 }} className="flex flex-wrap gap-4">
                ...
                <Link to="/packs">
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="flex items-center gap-2 px-8 py-4 font-semibold text-white transition-all duration-300 border rounded-full border-white/20 backdrop-blur-sm hover:bg-white/10 hover:shadow-lg hover:shadow-white/5"
                  >
                    <Music size={20} />
            ...
            >
              <motion.div variants={item} className="grid grid-cols-2 gap-6" transition={{ duration: .8 }}>
                <div className="p-6 space-y-4 transition-colors rounded-3xl bg-white/10 backdrop-blur-md hover:bg-white/15">
              ...
              <motion.div variants={item} transition={{ duration: .8 }} className="p-6 transition-colors rounded-3xl bg-white/10 backdrop-blur-md hover:bg-white/15">
