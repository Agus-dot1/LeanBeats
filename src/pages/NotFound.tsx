    ...
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-b from-bg-300 via-bg-300 to-bg-100">
      <div className="px-4 text-center">
        ...
        <div className="space-x-4">
          <button 
            onClick={() => navigate('/')}
            className="px-6 py-2 rounded-lg transition-colors text-text-100 bg-primary-200 hover:bg-primary-200"
          >
            Volver al inicio
          </button>
          <button 
            onClick={() => navigate(-1)}
            className="px-6 py-2 rounded-lg border transition-colors text-text-100 border-white/20 hover:bg-white/10"
          >
            Volver atrás
          </button>
        </div>
